...
# python val.py --weights runs/train/select_half/weights/best.pt --batch-size 32 --task test --name webcam_sl_half
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/webcam.yaml', help='dataset.yaml path')
